...
public class SwapService : ISwapService
{
    ...
    public static readonly string CacheKey = nameof( SwapService );
    public static readonly string BaseCoin = "USDT";

    public SwapService( IMemoryCache cache, IBinanceClient client, ILogger<SwapService> logger )
    {
        _cache  = cache;
        _client = client;
        _logger = logger;
    ...
    private async Task FetchSwapPools()
    {
        ...
        var swapPoolsResponse = await _client.BSwap.GetBSwapPoolsAsync();
